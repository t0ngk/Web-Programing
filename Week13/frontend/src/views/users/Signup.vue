        ...
        <div class="column is-4">
          ...
          <div class="field">
            ...
            <template v-if="$v.username.$error">
              ...
              <p class="help is-danger" v-if="!$v.username.minLength">Username must be at least 5 characters</p>
              <p class="help is-danger" v-if="!$v.username.maxLength">Username must be less than 20 characters</p>
            </template>
          </div>
          ...
          <div class="field">
            ...
            <template v-if="$v.password.$error">
              ...
              <p class="help is-danger" v-if="!$v.password.minLength">Password must be at least 8 characters</p>
              <p class="help is-danger" v-if="!$v.password.complex">Password must contain at least one uppercase, one
                lowercase, and one number</p>
            </template>
          </div>
          ...
          <div class="field">
            ...
            <template v-if="$v.confirm_password.$error">
              <p class="help is-danger" v-if="!$v.confirm_password.sameAs">Passwords do not match</p>
            </template>
          </div>
          ...
          <div class="field">
            ...
            <template v-if="$v.first_name.$error">
              ...
              <p class="help is-danger" v-if="!$v.first_name.maxLength">First Name must be less than 150 characters</p>
            </template>
          </div>
          ...
          <div class="field">
            ...
            <template v-if="$v.last_name.$error">
              ...
              <p class="help is-danger" v-if="!$v.last_name.maxLength">Last Name must be less than 150 characters</p>
            </template>
          </div>
